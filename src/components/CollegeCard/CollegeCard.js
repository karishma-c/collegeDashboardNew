                            ...
                            <div className="collegeCard">
                                <div className="collegeCardHeader">
                                    ...
                                    <div id="hideIcons" className="headerOptions">
                                        <svg id="headerAddIcon" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-plus" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#6050DC" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                            <path d="M12 5l0 14" />
                                            <path d="M5 12l14 0" />
                                        </svg>
                                ...
                                <div className="additionalDetails">
                                    <div className="admission">
                                        <h3 className="admissionHeading">
                                            <svg id="admissionIcon" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-school" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#6050DC" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                    ...
                                    <div className="distance">
                                        <h3 className="distanceHeading">
                                            <svg id="distanceIcon" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-scooter" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#6050DC" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                    ...
                                    <div className="fees">
                                        <h3 className="feesHeading">
                                            <svg id="feesIcon" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-coin" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#6050DC" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
